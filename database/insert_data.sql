...
INSERT INTO education_training(username, password, address, token_code, role_code, first_name, last_name, phone_number, email, picture) 
VALUES("admin", "123456", "Thành phố Hồ Chí Minh", "kjflhaskdfjayoiuyiuyiupiouoiyuytidmnfsfdsgdbhsldkfjas", "ADMIN", "Phòng", "Đào tạo", "0123456789", "phongdaotao@gmail.com", "/api/file/education_training/admin/avatar.png");
...
('19110145', 'Quảng Bình', '2001-04-25 00:00:00', 'admin', '2021-05-10 02:57:05', 'Cao Quý', 'Cao Quý Nhân', 'Male', 'Nhân', 'admin', '2021-05-10 02:57:05', '19110145', '0983754321', '/api/file/student/19110145/avatar.png', 2021, 'eyJhbGciOiJIUzI1NiJ9..Kbh3CLdJw4mXrPrvi2Uys1YJPQ', '19110145', 'STUDENT'),
('19110146', 'Quảng Bình', '2001-04-30 00:00:00', 'admin', '2021-05-10 02:57:05', 'Cao Như', 'Cao Như Thuần', 'Male', 'Thuần', 'admin', '2021-05-10 02:57:05', '19110146', '0807654321', '/api/file/student/19110146/avatar.png', 2021, 'eyJhbGciOiJIUzI1NiJ9._E', '19110146', 'STUDENT');;

INSERT INTO lecturer(username, password, fullname, birthday, phone_number, address, token_code, picture, role_code) VALUES
("lecturer1", "123456", "Nguyễn Văn Hiển", "1974-07-15 00:00:00", "0875543975", "Hồ Chí Minh", "zsdfasdfcvzutuyruytetrewerytuiyoppuioyiuoyoiucxvzx", "/api/file/lecturer/1/avatar.png", "LECTURER"),
("lecturer2", "123456", "Nguyễn Trần Thi Văn", "1981-09-20 00:00:00", "0375543976", "Hồ Chí Minh", "vxzcvaefwefmnvcxnvvcxnbvbxfdshfdhrtdhtuetrertdjwfecs", "/api/file/lecturer/2/avatar.png" ,"LECTURER"),
("lecturer3", "123456", "Trần Thị Phú", "1984-06-15 00:00:00", "0875283976", "Hồ Chí Minh", "vxzcvaefwefmnvcxnvvcakjflhasdxnbvbxfdshfdhrtdhtuetrertdjwfecs", "/api/file/lecturer/3/avatar.png" ,"LECTURER");


INSERT INTO course(id, name, number_of_credit, fee) VALUES
("MATH01", "Toán 1", 3, 2250000),
("MATH02", "Toán 2", 3, 2250000),
("PHYSICS01", "Lý 1", 4, 3000000),
("WDPG", "Lập trình Window", 3, 2250000);


INSERT INTO section_class(id, name, course_id, room, lecturer_id, period, description) VALUES
("MATH01_20_01", "Toán 1 - Nhóm 1", "MATH01", "A3-303", 1, 15, "Đây là Nhóm 1 của môn Toán 1."),
...
INSERT INTO register(student_id, section_class_id, midterm_mark, endterm_mark) VALUES
("19110143", "MATH01_20_01", 9.5, 7.5),
...
INSERT INTO notification(title, short_description, content) VALUES
("Thông báo 1", "Đây là mô tả ngắn của thông báo 1", "Đây là content của thông báo 1"),
